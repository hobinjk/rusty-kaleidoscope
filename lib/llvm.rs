...
// Consts for the LLVMVerifierFailureAction defined in llvm-c/Analysis.h
#[repr(C)]
...
pub mod llvm {
    ...
    use super::{GenericValueRef, ValueRef, TargetMachineRef, FileType, ArchiveRef};
    ...
    extern {
        ...
        pub fn LLVMVerifyFunction(Fn: ValueRef, VFA: c_uint) -> Bool;
        ...
        pub fn LLVMGenericValueToFloat(Type: TypeRef, GenValue: GenericValueRef) -> f64;
